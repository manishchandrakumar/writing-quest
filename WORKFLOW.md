...
1. **Drop** the day's worksheet photo (either way works):
   - Save it to `worksheets/completed/` *(any filename — Claude renames it)*, or
...
1. Locates the photo — checks `worksheets/completed/` first, then Cowork uploads.
...
|---|---|---|
| `worksheets/Day_*.pdf` | Printable blanks | Yes (committed to GitHub) |
| `worksheets/completed/` | Arnav's photographed work | **No** — gitignored, stays local |
